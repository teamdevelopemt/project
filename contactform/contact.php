      ...
      <form class="needs-validation" novalidate method="post" action="confirm.php">
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-4">
            ...
            <div class="pt-3">
              <input type="checkbox" name="time01[]" value="01">午前
              <input type="checkbox" name="time01[]" value="02">午後
              <input type="checkbox" name="time01[]" value="03">夕方以降
            </div>
          </div>
          ...
          <div class="col-md-12 mb-4">
            ...
            <div class="pt-3">
              <input type="checkbox" name="time02[]" value="01">午前
              <input type="checkbox" name="time02[]" value="02">午後
              <input type="checkbox" name="time02[]" value="03">夕方以降
            </div>
          </div>
          <!-- detail post -->
          <div class="col-md-12 mb-3">
